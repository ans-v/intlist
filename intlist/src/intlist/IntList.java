...
public class IntList {
	 ...
	 * @post The elements of this list at existing indices equal the old elements at the same indices.
	 ...
	 * @post This list's elements at indices not less than the given index equal those of the old ones at an index one greater.
	 * 		| Arrays.equals(getElements(), index, getSize(), old(getElements()), index + 1, old(getSize()))
	 *@throws IllgealArgumentException
	 * The given index is not between 0 (inclusive) and this list's size (exclusive)
	 *		| !(0 <= index && index < getSize())
	 */
	 ...
	 * @pre The given index is between 0 and this list list's size (inclusive)
	 * 		| 0 <= index && index < getSize()
	 ...
	 * 		| Arrays.equals(getElements(), 0, index, old(getElements()), 0, index)
	 * @post The elements at the indices not less than the given index equal the elements at an index one less in the old list.
	 * 		| Arrays.equals(getElements(), index + 1, getSize(), old(getElements()), index, old(getSize()))
	 * @post The elements at the given index equals the given value.
